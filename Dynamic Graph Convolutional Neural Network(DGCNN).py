# -*- coding: utf-8 -*-
"""
Created on Tue Dec  9 12:58:27 2025
...
class DGCNN(nn.Module):
    ...
    def __init__(self,  repres=4):
        ...
        self.linear3 = nn.Linear(256, repres)
    ...
    def forward(self, x):
        ...
        x = F.leaky_relu(self.bn6(self.linear1(x1)), negative_slope=0.2)
        x = self.dp1(x)
